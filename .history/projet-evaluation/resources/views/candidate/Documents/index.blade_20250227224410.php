...
<x-app-layout>
    ...
    <div id="rejection-modal" class="fixed inset-0 overflow-y-auto hidden" aria-labelledby="rejection-modal-title" role="dialog" aria-modal="true" style="z-index: 50;">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"></div>
    ...
    <script>
        ...
        function viewDocument(documentId) {
            ...
            const previewPdf = document.getElementById('document-preview-pdf');
            ...
            fetch(`/candidate/documents/${documentId}/preview`)
                ...
                .catch(error => {
                    ...
                    loading.innerHTML = '<p class="text-red-500">Erreur lors du chargement du document.</p>';
                });
        }
