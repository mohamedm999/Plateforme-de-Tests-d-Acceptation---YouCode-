            ...
            <div class="mb-6 overflow-hidden bg-white shadow-xl rounded-xl">
                <div class="p-6 bg-white lg:p-8">
                                ...
                                <div class="overflow-hidden transition-shadow duration-300 bg-white border rounded-xl hover:shadow-lg
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="space-y-3 ml-11">
                                            @foreach($question->options as $option)
                                                ...
                                                <div class="flex items-center p-3 {{
                                                    ...
                                                    @endif
                                                    <span class="{{
                                                        $isSelected ? 'font-medium ' . ($option->is_correct ? 'text-green-700' : 'text-red-700') :
                                        ...
                                        @if($question->explanation)
                                            <div class="p-4 mt-4 text-sm border-l-4 border-blue-400 ml-11 bg-blue-50 rounded-r-md">
                                                <div class="flex">
                                                    <svg class="w-5 h-5 mr-2 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2h-1V9a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                                                    </svg>
                                                    <p class="text-blue-700"><span class="font-medium">Explanation:</span> {{ $question->explanation }}</p>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                    ...
                    <div class="flex justify-center mt-10">
                        <a href="{{ route('quizzes.index') }}" class="inline-flex items-center px-6 py-3 text-white transition-colors duration-300 bg-indigo-600 rounded-md shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
