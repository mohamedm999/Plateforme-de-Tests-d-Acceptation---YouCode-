                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if($test->status === 'pending' && $test->can_start)
                                                    <a href="{{ route('candidate.tests.start', $test->id) }}" class="text-indigo-600 hover:text-indigo-900">Start Test</a>
                                                @elseif($test->status === 'in_progress')
                                                    <a href="{{ route('candidate.tests.continue', $test->id) }}" class="text-indigo-600 hover:text-indigo-900">Continue</a>
                                                @elseif($test->status === 'completed')
                                                    <a href="{{ route('candidate.tests.results', $test->id) }}" class="text-indigo-600 hover:text-indigo-900">View Results</a>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
