                    ...
                    @if (auth()->user()->role === 'candidat')
                        <div class="pl-4 border-l-4 border-blue-500">
                            ...
                            <div class="grid grid-cols-1 gap-4 mt-6 md:grid-cols-2">
                                ...
                                <a href="{{ route('cdocuments.index') }}" class="flex items-center p-4 text-white transition duration-150 rounded-lg shadow bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-800 hover:to-gray-900">
