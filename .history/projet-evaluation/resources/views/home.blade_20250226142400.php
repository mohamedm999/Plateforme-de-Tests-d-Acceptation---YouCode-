                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-4">
                        <p class="text-sm text-gray-600">
                            Pour toute question concernant le processus d'évaluation ou si vous rencontrez des difficultés techniques, n'hésitez pas à contacter notre équipe de support. Nous sommes disponibles du lundi au vendredi de 9h à 18h.
                        </p>
                        <div class="mt-4 flex flex-col sm:flex-row gap-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-700">support@youcode.ma</span>
                            </div>
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 mr-2" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                </svg>
                                <span class="text-gray-700">+212 520 123 456</span>
                            </div>
                        </div>
                    </div>
                </div>
