                    ...
                    @if (auth()->user()->role === 'candidat')
                        <div class="border-l-4 border-blue-500 pl-4">
                            ...
                            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <a href="{{ route('') }}" class="flex items-center p-4 bg-gradient-to-r from-gray-700 to-gray-800 text-white rounded-lg shadow hover:from-gray-800 hover:to-gray-900 transition duration-150">
